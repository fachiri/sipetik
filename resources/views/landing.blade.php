        ...
        <div class="w-11/12 md:w-2/5 2xl:mt-20 border p-7 bg-white rounded shadow-xl">
            ...
            <div id="content1" class="tab-content hidden">
                <form method="POST" action="{{ route('report.store') }}">
                    ...
                    <select name="kategori" id="kategori_permintaan" class="w-full rounded border-2 border-[#D9D9D9] text-xs py-3 px-6 mb-2">
                        <option value="" hidden>Kategori Permintaan</option>
            ...
            <div id="content3" class="tab-content hidden">
                <form method="POST" action="{{ route('report.store') }}">
                    ...
                    <select name="kategori" id="kategori_saran" class="w-full rounded border-2 border-[#D9D9D9] text-xs py-3 px-6 mb-2">
                        <option value="" hidden>Kategori Saran</option>
                        @foreach ($categories as $category)
                            <option value="{{ $category->name }}">{{ $category->name }}</option>
                        @endforeach
                    </select>
